...
public class TreePanel extends JScrollPane implements FIXPropertyListener {
	...
	public TreePanel(final TopPanel topPanel) {
		...
		final ImageIcon leafIcon = new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/mail_generic.png"));
		...
		if (leafIcon != null) {
			...
			renderer.setClosedIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/folder.png")));
			renderer.setOpenIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/folder.png")));
