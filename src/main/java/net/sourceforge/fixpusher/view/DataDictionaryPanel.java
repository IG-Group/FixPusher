...
public class DataDictionaryPanel extends AbstractMainPanelContent {
	...
	public DataDictionaryPanel(final MainPanel mainPanel, final boolean enabled) {
		...
		settingsLabel.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/24x24/txt.png")));
		...
		if (enabled)
			mainPanel.setStatusInfo(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/status_unknown.png")),
