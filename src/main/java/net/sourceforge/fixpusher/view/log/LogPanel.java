...
public class LogPanel extends JPanel implements FIXMessageFilterListener {
	...
	public LogPanel(final TopPanel topPanel, final LogTableModel logTableModel) {
		...
		openFIXMessageMenuItem.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/mail_generic.png")));
		...
		adoptValuesMenuItem.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/insertcellcopy.png")));
