...
public class FieldCheckResult {
	...
	private final ImageIcon error = new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/stop.png"));

	private String tooltipText = null;

	private final ImageIcon warning = new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/status_unknown.png"));
