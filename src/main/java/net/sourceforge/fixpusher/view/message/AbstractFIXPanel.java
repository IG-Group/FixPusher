...
public abstract class AbstractFIXPanel extends JPanel {
	...
	public AbstractFIXPanel(final AbstractFIXPanel parent, final AbstractFIXElement abstractFIXElement, final FieldMap fieldMap, final boolean enabled,
		...
		addButton.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/edit-add.png")));
		...
		removeButton.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/edit-delete.png")));
