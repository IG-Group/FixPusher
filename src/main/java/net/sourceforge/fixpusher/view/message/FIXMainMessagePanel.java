...
public class FIXMainMessagePanel extends AbstractMainPanelContent {
	...
	public FIXMainMessagePanel(final FIXMessage fixMessage, final Message message, final MainPanel mainPanel) {
		...
		backImageIcon = new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/logo.png"));
		...
		filterLabel.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/filter.png")));
		...
		searchButton.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/search.png")));
		...
		messageLogoLabel.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/22x22/mail_generic.png")));
