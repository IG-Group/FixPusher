...
public class ExceptionDialog extends JDialog {
	...
	public ExceptionDialog() {
		...
		titelLabel.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/22x22/messagebox_warning.png")));
		...
		cancelButton.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/fileclose.png")));
