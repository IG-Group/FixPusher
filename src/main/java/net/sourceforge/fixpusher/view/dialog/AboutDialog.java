...
public class AboutDialog extends JDialog {
	...
	private final ImageIcon backImage = new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/about.png"));
	...
	public AboutDialog() {
		...
		setIconImage(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/f-logo.png")).getImage());
		...
		contactLabel.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/22x22/mail_new3.png")));
		...
		closeButton.setIcon(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/fileclose.png")));
