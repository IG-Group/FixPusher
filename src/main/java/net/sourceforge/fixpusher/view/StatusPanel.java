...
public class StatusPanel extends JPanel {
	...
	private final ImageIcon greenLED = new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/greenled.png"));
	private final JLabel infoIconLabel;
	private final JLabel infoTextLabel;
	private final JLabel connectionLabel;
	private final JLabel connectionIconLabel;

	private final ImageIcon redLED = new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/redled.png"));

	private final ImageIcon yellowLED = new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/yellowled.png"));
	...
	public StatusPanel() {
		...
		setStatusInfo(new ImageIcon(FIXPusher.class.getClassLoader().getResource("images/16x16/documentinfo.png")),
